...
class MainController: CoreController {
    ...
    private lazy var addCard: UIImageView = {
        ...
        i.image = UIImage(named: "add-payment-card")
...
//        i.image = .deleteCard
        i.layer.cornerRadius = 20
        i.image = UIImage(named: "delete-button")
...
//        i.image = .card
        i.alpha = 1
        i.image = UIImage(named: "icons_170255")
//        i.image = .transfer
        i.layer.cornerRadius = 20
        i.clipsToBounds = true
        i.contentMode = .scaleAspectFill
...
extension MainController:UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        cell.panLabel.text = "**** "+(card.pan?.suffix(4) ?? "****")
        cell.dateLabel.text = card.date ?? "ErrorErrorError"
